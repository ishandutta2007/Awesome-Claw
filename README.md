# Awesome Claw: OpenClaw Alternatives & Similar Projects 🦞

A curated list of **open-source GitHub projects** similar to **[OpenClaw](https://github.com/openclaw/openclaw)** — self-hosted personal AI assistants that run locally, integrate with messaging platforms (WhatsApp, Telegram, Discord, Slack, etc.), support agents/tools/memory, and emphasize privacy, lightness, or security.

OpenClaw is the viral original (200k+ stars): a full-featured TypeScript gateway for persistent AI agents across chat apps.

**Contributions welcome!** Add your project via PR (keep it relevant, active, and OSS).

## Table of Contents
- [Original](#original)
- [Lightweight & Minimal](#lightweight--minimal)
- [Secure & Reimplementations (Rust/Zig/Go)](#secure--reimplementations-rustziggo)
...
- **[OpenClaw](https://github.com/openclaw/openclaw)**  
  The full-featured personal AI assistant. Multi-channel messaging, skills, voice, canvas, 24/7 gateway. (TypeScript, ~200k+ stars)
...
- **[Mini-Claw](https://github.com/htlin222/mini-claw)**  
  Minimalist Telegram bot using Pi agent. No extra API costs — uses your Claude/ChatGPT subscription directly.

## Secure & Reimplementations (Rust/Zig/Go)
...
- **[NanoClaw](https://github.com/qwibitai/nanoclaw)** (also mirrored as gavrielc/nanoclaw)  
  Container-isolated (Docker/Apple) agents for true OS-level security. ~500 lines core, WhatsApp + scheduled jobs + memory.
...
- **[ClawSwarm](https://github.com/The-Swarm-Corporation/ClawSwarm)**  
  Lighter multi-agent version built on Swarms framework. Natively multi-agent, Telegram-first, compiles to Rust.
...
- **[VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills)** — 5,400+ skills for the OpenClaw ecosystem (not alternatives, but essential extensions).
...
**Stars & activity** change fast — check the repos for latest metrics.

---

**Made with ❤️ for the Claw community**  
Last updated: March 2026  
Star this repo if it helps! Feel free to fork and maintain your own version.
